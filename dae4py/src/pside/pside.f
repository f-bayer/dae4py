...
C
CMIC$ DOALL PRIVATE(KS,KN,KN2)
CMIC$+      SHARED(HLU,D,DGDY,NLM,NUM,DGDDY,
CMIC$+             NEQN,NLJ,NUJ,DECLUS,LDLU,IPVTS,INFO)
            DO 50 KS=1,S
               DO 20 KN=1,NEQN
...
CMIC$ DOALL PRIVATE(KS,KN,KN2)
CMIC$+      SHARED(HLU,D,DGDY,NLM,NUM,DGDDY,
CMIC$+             NEQN,DECLUS,LDLU,IPVTS,INFO)
            DO 100 KS=1,S
               DO 70 KN=1,NEQN
                  DO 60 KN2=1,NEQN
...
C-----------------------------------------------------------------------
      IERR=0
CMIC$ DOALL PRIVATE(KS)
CMIC$+      SHARED(GEVAL,NEQN,T,C,H,YS,DYS,UDYS,IERRS,RPAR,IPAR)
      DO 10 KS=1,S
         IERRS(KS)=0
...
C-----------------------------------------------------------------------
      IF (JBND) THEN
CMIC$ DOALL PRIVATE(KS,KN,KS2)
CMIC$+      SHARED(TGS,QINV,UDYS,
CMIC$+             NEQN,NLJ,NUJ,DECLUS,LDLU,IPVTS,TUDYS,INFO)
         DO 60 KS=1,S
            DO 20 KN=1,NEQN
               TGS(KN,KS)=0D0
   20       CONTINUE
...
CMIC$ DOALL PRIVATE(KS,KN,KS2)
CMIC$+      SHARED(TGS,QINV,UDYS,
CMIC$+             NEQN,DECLUS,LDLU,IPVTS,TUDYS,INFO)
         DO 110 KS=1,S
C           DO 70 KN=1,NEQN
C              TGS(KN,KS)=0D0
C  70       CONTINUE
...
C-----------------------------------------------------------------------
         IF (JBND) THEN
CMIC$ DOALL PRIVATE(KS,KN,KN2,KB)
CMIC$+      SHARED(TGS,NLM,NUM,DGDDY,B,TUDYS,
CMIC$+             NEQN,NLJ,NUJ,DECLUS,LDLU,IPVTS,UDYS,NEQN,INFO)
            DO 150 KS=1,S
               KB=KS-MOD(KS+1,2)
               DO 120 KN=1,NEQN
...
CMIC$ DOALL PRIVATE(KS,KN,KN2,KB)
CMIC$+      SHARED(TGS,NLM,NUM,DGDDY,B,TUDYS,
CMIC$+             NEQN,DECLUS,LDLU,IPVTS,UDYS,INFO)
            DO 190 KS=1,S
               KB=KS-MOD(KS+1,2)
               DO 160 KN=1,NEQN
                  UDYS(KN,KS)=TGS(KN,KS)
...
C              INFO returns 0 (no argument with illegal value)
  ...
  190       CONTINUE
         ELSE
CMIC$ DOALL PRIVATE(KS,KN,KN2,KB)
CMIC$+      SHARED(TGS,DGDDY,B,TUDYS,
CMIC$+             NEQN,DECLUS,LDLU,IPVTS,UDYS,NEQN,INFO)
            DO 230 KS=1,S
               KB=KS-MOD(KS+1,2)
               DO 200 KN=1,NEQN
                  UDYS(KN,KS)=TGS(KN,KS)
